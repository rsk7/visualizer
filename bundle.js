...
/***/ function(module, exports, __webpack_require__) {
	...
	var _microphone = __webpack_require__(3);
	...
	var _hAudioDataProvider = __webpack_require__(5);

	var _hAudioDataProvider2 = _interopRequireDefault(_hAudioDataProvider);

	var _bars = __webpack_require__(12);

	var _bars2 = _interopRequireDefault(_bars);

	var _soundcloud = __webpack_require__(15);
	...
	window.h = __webpack_require__(6);

	var BAR_COUNT = 300;

	var mic = new _microphone2.default();
	var noise = new _noise2.default();
	var sc = new _soundcloud2.default();
	var eqBars = new _bars2.default(".eq", BAR_COUNT);

	var el = function el(id) {
	    return document.getElementById(id);
	};
	var clickListen = function clickListen(id, func) {
	    return el(id).addEventListener("click", func);
	};

	function micToggle() {
	    mic.toggle();
	    eqBars.setDataProvider(function () {
	        return mic.dataProvider().frequency();
	    });
	};

	function noiseToggle() {
	    eqBars.setDataProvider(function () {
	        return noise.dataProvider().time();
	    });
	    noise.toggle();
	};
	...
	function hAudioToggle() {
	    eqBars.setDataProvider(function () {
	        return _hAudioDataProvider2.default.frequency();
	    });
	};

	function hAudioTimeDomainToggle() {
	    eqBars.setDataProvider(function () {
	        return _hAudioDataProvider2.default.time();
	    });
	};

	function oscToggle() {
	    eqBars.setDataProvider(function () {
	        return _oscillator2.default.time();
	    });
	}
	...
	function scToggle() {
	    ...
	    // yup
	    var audioEl = el("sc-track");
	    audioEl.getAttribute("hidden") === "" ? audioEl.removeAttribute("hidden") : audioEl.setAttribute("hidden", "");

	    eqBars.setDataProvider(function () {
	        return sc.dataProvider().frequency();
	    });
	}
	...
	document.addEventListener("DOMContentLoaded", function () {
	    ...
	    var trackUrl = "https://soundcloud.com/rsk7/sounds-from-monday-evening";
	    el("trackUrl").value = trackUrl;
	    sc.track(trackUrl);
	    el("trackUrl").addEventListener("change", function (e) {
	        return sc.track(e.target.value);
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataProvider = __webpack_require__(2);
	...
	var Noise = (function () {
	    function Noise() {
	        ...
	        var analyser = webaudioNodes.analyser;
	        this.dataProviderSource = new _dataProvider2.default(analyser);
	    }
...
/***/ function(module, exports) {
	...
	var DataProvider = (function () {
	    function DataProvider(analyser) {
	    ...
	    _createClass(DataProvider, [{
	        ...
	        value: function time() {
	            ...
	            var timeData = new Float32Array(this.analyser.fftSize);
	...
	var Mic = (function () {
	    ...
	    _createClass(Mic, [{
	        ...
	        value: function setup(stream) {
	            this.stream = stream;
	            var analyser = processInput(this.stream);
	            this.dataProviderSource = new _dataProvider2.default(analyser);
	        }
	    }, {
	        key: "dataProvider",
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = new _dataProvider2.default(createSource());
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = new _dataProvider2.default(h.analyser);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteDictionary = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clientId = __webpack_require__(17).Id;
	var sc = __webpack_require__(18);
	sc.initialize({ client_id: clientId });

	function getAnalyser(audioPlayer) {
	    audioPlayer.crossOrigin = "anonymous";
	    var audioSrc = _audioContext2.default.createMediaElementSource(audioPlayer);
	    var gainNode = _audioContext2.default.createGain();
	    var analyser = _audioContext2.default.createAnalyser();
	    audioSrc.connect(gainNode);
	    gainNode.connect(analyser);
	    analyser.connect(_audioContext2.default.destination);
	    // gainNode.gain.value = 0;
	    return { gainNode: gainNode, analyser: analyser };
	}

	var SoundCloudSource = (function () {
	    function SoundCloudSource() {
	        _classCallCheck(this, SoundCloudSource);
	    }

	    _createClass(SoundCloudSource, [{
	        key: "setup",
	        value: function setup(audioPlayer) {
	            this.audioPlayer = audioPlayer;
	        }
	    }, {
	        key: "track",
	        value: function track(url) {
	            var _this = this;

	            sc.resolve(url).then(function (result) {
	                _this.audioPlayer.setAttribute("src", result.stream_url + "?client_id=" + clientId);
	                var nodes = getAnalyser(_this.audioPlayer);
	                _this.gainNode = nodes.gainNode;
	                _this.dataProviderSource = new _dataProvider2.default(nodes.analyser);
	            });
	        }
	    }, {
	        key: "dataProvider",
	...
	exports.default = SoundCloudSource;
...
/***/ function(module, exports) {
	...
	module.exports = {
		"Id": "dca724bd53201bc477f8d489eb3b8ea5"
	};
